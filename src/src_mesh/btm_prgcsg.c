...
u64 BTM_PgmCmd_CsgAabb(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs);
u64 BTM_PgmCmd_CsgCube(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs);
u64 BTM_PgmCmd_CsgSphere(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs);
u64 BTM_PgmCmd_CsgCylinder(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs);
u64 BTM_PgmCmd_CsgUnion(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs);
