...
u64 BTM_PgmDoEvalExpr(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs);
u64 BTM_PgmEvalExpr(BTM_World *wrl, char *str);
...
int BTM_PgmDoGotoTok(BTM_World *wrl, BTM_ConPgm *pgm, int lblid)
{
	int i;
...
u64 BTM_PgmGetGlobal(BTM_World *wrl, int tok)
{
	char *s0, *s1;
	u64 val;
	s64 lx;
...
u64 BTM_PgmSetGlobal(BTM_World *wrl, int tok, u64 val)
{
	char *s0, *s1;
	int i, j, k;
...
u64 BTM_PgmGetLocal(BTM_World *wrl, int tok)
{
	u64 val;
	int i, j, k;
...
u64 BTM_PgmSetLocal(BTM_World *wrl, int tok, u64 val)
{
	int i, j, k;
...
u64 BTM_PgmBindDynamic(BTM_World *wrl, int tok, u64 val)
{
	int i;
...
u64 BTM_PgmGetGlobalName(BTM_World *wrl, char *name)
{
	char tb[64];
	int tok;
	sprintf(tb, "I%s", name);
...
int BTM_PgmDoEvalCommaList(BTM_World *wrl, BTM_ConPgm *pgm,
	u16 **rtcs, u64 *args)
{
	u16 *tcs;
	u64 val;
...
int BTM_PgmDoEvalArgsList(BTM_World *wrl, BTM_ConPgm *pgm,
	u16 **rtcs, u64 *args)
{
	u16 *tcs;
	u64 val;
...
int BTM_PgmDoEvalNamedArgsList(BTM_World *wrl, BTM_ConPgm *pgm,
...
u64 BTM_PgmDoEvalExprLit(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	u64 args[16];
	u16 *tcs;
	u16 t0, t1, t2;
...
u64 BTM_PgmDoEvalExprUnary(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	BTM_PgmExt *ext;
	u16 *tcs;
	u64 vala, valb, val;
...
u64 BTM_PgmDoEvalExprMD(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	BTM_PgmExt *ext;
	u16 *tcs;
	u64 vala, valb, val;
...
u64 BTM_PgmDoEvalExprAS(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	u16 *tcs;
	u64 vala, valb, val;
	int opr, tok;
...
u64 BTM_PgmDoEvalExprSHLR(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	u16 *tcs;
	u64 vala, valb, val;
	int opr, tok;
...
u64 BTM_PgmDoEvalExprBitOp(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	u16 *tcs;
	u64 vala, valb, val;
	int opr, tok;
...
u64 BTM_PgmDoEvalExprCompare(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	u16 *tcs;
	u64 vala, valb, val;
	int opr, tok;
...
#if 0
u64 BTM_PgmDoEvalExprAssign(BTM_World *wrl, BTM_ConPgm *pgm, u16 **rtcs)
{
	u16 *tcs;
	u64 vala, valb, val;
	int opr, tok;
...
int BTM_PgmDoConCmd(BTM_World *wrl, BTM_ConPgm *pgm, u16 *tok, u16 *toke)
{
	char tbuf[256];
	u16 *tcs;
	char *cs, *ct, *s0;
...
int BTM_PgmDoConPrint(BTM_World *wrl, BTM_ConPgm *pgm, u16 *tok, u16 *toke)
{
	char tbuf[256];
	u16 *tcs;
	char *cs, *ct, *s0;
...
int BTM_PgmDoGosubArgs(BTM_World *wrl, BTM_ConPgm *pgm, u16 *tok, u16 *toke)
{
	u16 *tcs;
	u16 tvar;
	u64 vala;
...
int BTM_PgmDoStepTok(BTM_World *wrl, BTM_ConPgm *pgm, u16 *tok, u16 *toke)
{
	u64 args[16];
	BTM_PgmExt *ext;
	u16 *tcs;
...
int BTM_PgmDoStepLine(BTM_World *wrl, BTM_ConPgm *pgm)
{
	u16 *tok, *toke;
...
u64 BTM_PgmRun(BTM_World *wrl, char *pgmname, char *lblname)
{
	char tb[256];
	byte *ibuf;
	BTM_ConPgm *pgm;
...
int BTM_PgmEval(BTM_World *wrl, char *str)
{
	u16 toka[128];
	BTM_ConPgm *pgm;
	u16 *tcs;
